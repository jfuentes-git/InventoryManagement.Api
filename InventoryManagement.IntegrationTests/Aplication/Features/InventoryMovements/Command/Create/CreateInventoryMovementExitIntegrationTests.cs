...
public sealed class CreateInventoryMovementExitIntegrationTests : SqliteIntegrationTestBase
{

    [Fact]
    public async Task Handle_ShouldCreateInventoryMovementAndUpdateProductStock_WhenMovementIsExit()
    {
        ...
        var command = new CreateInventoryMovementCommand(product.Id, MovementType.Exit, 3);
        ...
        Assert.Equal(MovementType.Exit, movement.MovementType);
    }
}