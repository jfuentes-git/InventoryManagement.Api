...
namespace InventoryManagement.UnitTests.Aplication.Features.Categories.Command.Update;
    ...
    public class UpdateCategoryCommandHandlerNotFoundByQueryTest
    {
        ...
        public async Task Handle_ShouldThrowNotFoundException_WhenCategoryDoesNotExist()
        {
            ...
            var handler = new UpdateCategoryCommandHandler( repositoryMock.Object,repositoryQueryMock.Object);

            var command = new UpdateCategoryCommand(categoryId, "Electronics");
